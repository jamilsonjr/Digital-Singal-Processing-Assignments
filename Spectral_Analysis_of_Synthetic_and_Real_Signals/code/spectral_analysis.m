...
% impulses, 3 for the one sided version shown, one for each frequency in the signal.
...
frequencies = top_three_frequencies(dft,M); % Gets the indexes of the 3 main frequencies.
for n = 1:M
    sum  = 0;
    for k=frequencies
