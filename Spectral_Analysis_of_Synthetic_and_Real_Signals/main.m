...
% As opposite to the first signal,x, the voice has many more harmonics.
...
% reconstructed by the missing harmonics make the words in the signal less
% clear and audible.
% Also,since discrete-time signals are only unique over a 2pi interval and
